...
const typePreviewCards = [
  { emoji: "🚩", title: "읽씹하면서 스토리는 다 보는 남자", desc: "관심 있는 척 안 하면서 너 동선은 다 파악 중. 이런 남자한테 맨날 끌리잖아.", gradient: "from-[hsl(0,0%,10%)] to-[hsl(355,30%,12%)]" },
  { emoji: "🔥", title: "썸만 3개월째인 남자", desc: "\"우리 뭐야\"라고 물어보면 \"그냥 편한 사이\"래. 근데 너 아직도 기다리고 있지?", gradient: "from-[hsl(0,0%,10%)] to-[hsl(15,20%,12%)]" },
  { emoji: "💀", title: "전여친 얘기를 자연스럽게 꺼내는 남자", desc: "\"걔랑은 달라\" 이 말 듣고 감동받았지? 그거 모든 여자한테 하는 말이야.", gradient: "from-[hsl(0,0%,10%)] to-[hsl(30,15%,12%)]" },
  { emoji: "🧊", title: "잘해주다 갑자기 차가워지는 남자", desc: "푸시풀의 달인. 너 지금 \"내가 뭘 잘못했지\" 생각하고 있지? 그게 함정이야.", gradient: "from-[hsl(0,0%,10%)] to-[hsl(210,10%,12%)]" },
  { emoji: "🎭", title: "모든 여사친한테 다정한 남자", desc: "너한테만 특별한 줄 알았지? 카톡 프사 바꾸면 10분 안에 답장하는 여자 3명 더 있음.", gradient: "from-[hsl(0,0%,10%)] to-[hsl(340,15%,12%)]" },
  { emoji: "⚠️", title: "\"나 원래 연애 잘 안 해\" 라고 말하는 남자", desc: "연애를 안 하는 게 아니라 책임을 안 지는 거야. 근데 너 이미 빠졌잖아.", gradient: "from-[hsl(0,0%,10%)] to-[hsl(25,15%,12%)]" },
];
