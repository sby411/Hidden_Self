    ...
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-5">
        <div className="text-center max-w-sm">
          ...
          <button
            onClick={() => navigate("/")}
            className="h-11 px-8 rounded-xl bg-primary text-primary-foreground text-sm font-bold flex items-center justify-center gap-2 mx-auto hover:bg-primary/90 transition-colors"
          >
            처음으로
          </button>
        </div>
