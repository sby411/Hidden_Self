...
export const maleTypes: MaleType[] = [
  ...
  },
  {
    ...
    aiSummary: "당신의 인스타에서는 따뜻하고 편안한 감성이 가득 느껴져요. 포근한 색감과 일상적인 순간들을 소중히 담는 스타일이 인상적입니다. 이런 vibe는 순수하고 에너지 넘치는 연하남의 마음을 강하게 흔들어요. AI 분석 결과, 당신의 피드 키워드는 '따뜻한 포용력'입니다.",
    fallReasons: ["포근한 분위기에서 안정감과 동경을 동시에 느낌", "부드러운 이미지에서 이상형을 발견", "편안한 일상 콘텐츠에 자연스럽게 빠져듦", "따뜻한 에너지가 보호받고 싶은 욕구를 자극"],
    pros: ["순수하고 진심 어린 애정 표현", "에너지 넘치는 활력을 줌", "거짓 없이 솔직한 감정 전달"],
    cons: ["연애 경험 부족으로 가끔 미숙함", "질투심이 강하게 나타날 수 있음", "감정 기복이 심한 편"],
    attractionStats: [
  ...
  },
  {
    ...
    aiSummary: "당신의 인스타는 감성적이면서도 어딘가 신비로운 분위기가 감돌아요. 드라마틱한 색감과 의미심장한 캡션이 독특한 매력을 만들어내고 있습니다. 이런 감성은 강렬하고 예측 불가능한 도파민형 남자를 끌어당기는 자석 같은 역할을 해요. AI가 포착한 당신의 핵심 에너지는 '미스터리한 감성'입니다.",
    fallReasons: ["신비로운 분위기에서 정복하고 싶은 욕구를 느낌", "감성적인 면이 자신의 강렬함과 대비되어 매력적", "쉽게 읽히지 않는 성격이 도전 의식을 자극", "독특한 취향이 지루하지 않은 상대로 인식됨"],
    pros: ["강렬한 설렘과 두근거림", "넘치는 카리스마", "자유롭고 예측 불가능한 재미"],
    cons: ["감정의 롤러코스터가 심함", "안정적인 관계 유지가 어려움", "진심을 알기 어려운 순간들"],
    attractionStats: [
  ...
  },
  {
    ...
    aiSummary: "당신의 피드에는 아름다운 색감과 섬세한 구도의 사진이 가득해요. 일상 속 작은 아름다움을 포착하는 감성이 돋보이며, 전체적으로 미적 감각이 뛰어나다는 인상을 줍니다. 이런 감성은 예술가적 영혼을 가진 남자에게 깊은 공감대를 형성해요. AI가 읽은 당신의 피드 키워드는 '섬세한 미적 감각'입니다.",
    fallReasons: ["사진에서 느껴지는 섬세한 미적 감각에 영감을 받음", "같은 감성을 공유할 수 있는 사람이라 확신", "피드 속 아름다운 순간들에 예술적 공감", "독특한 시각으로 세상을 바라보는 점이 매력적"],
    pros: ["깊은 감성을 공유하는 교감", "로맨틱하고 창의적인 표현력", "예상치 못한 특별한 데이트"],
    cons: ["현실적인 면이 부족할 수 있음", "감정에 쉽게 빠지고 상처받음", "경제적 안정성이 낮을 수 있음"],
    attractionStats: [
  ...
  },
  {
    ...
    aiSummary: "당신의 인스타에서는 지적 호기심과 깊이 있는 취향이 돋보여요. 책, 전시, 의미 있는 콘텐츠를 즐기는 모습이 피드 전반에 드러나고 있습니다. 이런 분위기는 똑똑하고 깊이 있는 대화를 갈구하는 천재형 남자의 관심을 끌어요. AI가 분석한 당신의 매력 포인트는 '지적 호기심'입니다.",
    fallReasons: ["깊이 있는 취향에서 지적 동반자를 발견", "독특한 관점이 그의 호기심을 강하게 자극", "의미 있는 콘텐츠를 공유하는 감성에 공감", "대화가 통할 것 같다는 직감적 확신"],
    pros: ["지적이고 깊이 있는 대화", "함께하며 서로 성장 가능", "독립적이고 자기 세계가 확실함"],
    cons: ["감정 표현이 서툴러 답답할 수 있음", "사회성이 부족한 편", "자기 세계에 빠져 소통 부재"],
    attractionStats: [
  ...
  },
  {
    ...
    aiSummary: "당신의 피드에서는 절제되고 세련된 감성이 느껴져요. 과하지 않으면서도 자신만의 확실한 스타일을 가지고 있다는 인상을 줍니다. 쉽게 읽히지 않는 미스터리한 분위기가 츤데레 남자의 호기심을 자극해요. AI가 감지한 당신의 피드 에너지는 '절제된 카리스마'입니다.",
    fallReasons: ["쉽게 다가가기 어려운 분위기에서 도전 의식", "절제된 스타일에서 내면의 깊이를 예감", "차분한 에너지가 자신과 비슷하다고 느낌", "미스터리한 매력이 계속 알고 싶게 만듦"],
    pros: ["반전 매력의 다정함", "한번 빠지면 누구보다 진심", "독립적이고 쿨한 관계 유지"],
    cons: ["소통이 어렵고 속마음을 모름", "오해가 쉽게 생기는 관계", "감정 표현 타이밍이 늦음"],
    attractionStats: [
  ...
  },
  {
    ...
    aiSummary: "당신의 인스타는 자기관리와 성장에 진심인 에너지가 느껴져요. 목표 지향적인 콘텐츠와 성취의 순간들이 피드에 자연스럽게 녹아 있습니다. 이런 분위기는 같은 열정을 가진 야망형 사업가 남자의 레이더에 정확히 잡혀요. AI가 분석한 당신의 핵심 키워드는 '성장하는 에너지'입니다.",
    fallReasons: ["목표 지향적인 모습에서 같은 가치관을 발견", "자기관리하는 라이프스타일에 동질감", "함께 성장할 수 있는 파트너로 인식", "독립적이면서도 야망 있는 에너지에 끌림"],
    pros: ["강한 추진력으로 함께 성장", "명확한 비전을 공유하는 관계", "서로를 자극하며 발전하는 연애"],
    cons: ["일에 빠져 연인을 소홀히 할 수 있음", "항상 바빠서 여유가 없음", "관계에서도 효율을 추구하는 경향"],
    attractionStats: [
  ...
  },
  {
    ...
    aiSummary: "당신의 인스타는 밝고 에너지 넘치는 분위기가 핵심이에요. 친구들과의 즐거운 순간, 활발한 소셜 라이프가 피드 전반에 드러나고 있습니다. 이런 활기찬 에너지는 사교적이고 분위기를 이끄는 인기남의 관심을 자연스럽게 끌어요. AI 분석 결과, 당신의 피드 키워드는 '밝은 에너지'입니다.",
    fallReasons: ["활발한 소셜 라이프에서 공감대 형성", "밝은 에너지가 함께하면 더 재밌을 거란 확신", "사교적인 성격이 자신의 세계와 잘 맞음", "긍정적인 분위기가 주변을 밝게 만드는 매력"],
    pros: ["분위기 메이커로 항상 즐거움", "넓은 인맥을 통한 다양한 경험", "유머 감각으로 재미있는 일상"],
    cons: ["여자 사람 친구가 많아 불안함", "가벼워 보이는 인상", "깊은 감정 대화를 어려워할 수 있음"],
    attractionStats: [
  ...
  },
  {
    ...
    aiSummary: "당신의 피드에서는 로맨틱하고 감성적인 에너지가 물씬 풍겨요. 사랑스러운 일상과 감성적인 순간들을 소중히 담는 스타일이 뚜렷합니다. 이런 로맨틱한 분위기는 한 사람에게 올인하는 직진형 남자의 마음을 강하게 잡아당겨요. AI가 포착한 당신의 매력 포인트는 '로맨틱 감성'입니다.",
    fallReasons: ["로맨틱한 감성이 보호 본능을 강하게 자극", "감성적인 면에 깊이 공감하며 빠져듦", "자신만이 완벽하게 이해할 수 있다는 확신", "순수한 분위기에서 지키고 싶은 욕구 발동"],
    pros: ["확실하고 진심 어린 애정 표현", "기념일과 사소한 것까지 모두 기억", "한결같은 마음으로 일편단심"],
    cons: ["집착으로 발전할 가능성 있음", "독점욕이 강해 숨이 막힐 수 있음", "헤어짐을 받아들이기 어려움"],
    attractionStats: [
  ...
  },
  {
    ...
    aiSummary: "당신의 인스타는 다채롭고 모험적인 에너지가 가득해요. 다양한 장소와 경험을 담은 사진들이 자유로운 영혼을 보여주고 있습니다. 이런 분위기는 함께 세상을 탐험하고 싶은 여행남의 마음을 강하게 흔들어요. AI가 분석한 당신의 핵심 에너지는 '모험적 감성'입니다.",
    fallReasons: ["다채로운 피드에서 모험심을 발견", "함께라면 어디든 특별해질 거란 확신", "새로운 경험을 즐기는 열린 마인드에 끌림", "자유로운 에너지가 자신의 라이프스타일과 일치"],
    pros: ["다양하고 새로운 경험 공유", "열린 사고와 유연한 성격", "함께하는 모험이 관계를 깊게 함"],
    cons: ["한곳에 정착하기 어려워함", "연락이 뜸해지는 시기가 있음", "장기적 계획을 세우기 어려움"],
    attractionStats: [
      { label: "연상 끌림도", value: 55 },
      { label: "동갑 끌림도", value: 75 },
  ...
  },
  {
    ...
    aiSummary: "당신의 인스타에서는 정돈되고 깔끔한 라이프스타일이 느껴져요. 계획적이고 안정적인 일상이 피드에 자연스럽게 드러나고 있습니다. 이런 분위기는 같은 안정감을 추구하는 공기업 남자의 이상형과 정확히 맞아요. AI가 읽은 당신의 매력 키워드는 '신뢰감 있는 안정미'입니다.",
    fallReasons: ["깔끔한 피드에서 같은 가치관을 발견", "계획적인 라이프스타일에 동질감", "함께 안정적인 미래를 그릴 수 있다는 확신", "성실하고 진지한 분위기에 신뢰감을 느낌"],
    pros: ["안정적인 수입과 규칙적 생활", "믿음직하고 성실한 성격", "장기적인 관계에 진심인 태도"],
  ...
  },
  {
    ...
    aiSummary: "당신의 피드에서는 따뜻하고 아늑한 홈 감성이 느껴져요. 소소한 일상을 소중히 여기는 마음이 사진 곳곳에서 드러나고 있습니다. 이런 편안한 분위기는 집에서 함께 시간을 보내고 싶은 집돌이 남자에게 이상적인 매력으로 작용해요. AI가 감지한 당신의 핵심 에너지는 '아늑한 안정감'입니다.",
    fallReasons: ["아늑한 분위기에서 이상적인 파트너를 발견", "편안한 일상을 함께할 수 있다는 기대감", "소소한 것을 소중히 여기는 가치관에 공감", "따뜻한 에너지가 자신의 안식처 같은 느낌"],
    pros: ["바람 걱정이 없는 안심 연애", "함께 즐기는 공통 취미", "편안하고 부담 없는 관계"],
    cons: ["외출과 데이트를 꺼리는 경향", "게임에 빠져 연인을 방치할 수 있음", "사회적 활동에 소극적"],
    attractionStats: [
