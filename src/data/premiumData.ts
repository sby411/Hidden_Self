...
const stageTemplates = [
  [
    { title: "관심 감지", description: "당신의 인스타 vibe에서 호기심을 느끼고, 스토리를 반복 확인하기 시작합니다.", emoji: "👀" },
    { title: "가치관 탐색", description: "당신의 라이프스타일, 취향, 인간관계를 조용히 관찰하며 자신과 맞는지 판단합니다.", emoji: "🔍" },
    { title: "감정 투자", description: "관심이 확실해지면 DM이나 리액션으로 존재를 알리기 시작합니다.", emoji: "💭" },
    { title: "관계 결정", description: "충분한 확인 후 본격적으로 만남을 추진하며 연애를 시작합니다.", emoji: "💕" },
  ],
  [
    { title: "첫인상 각인", description: "당신의 피드를 처음 보는 순간 강한 끌림을 느끼고 머릿속에 각인됩니다.", emoji: "⚡" },
    { title: "정보 수집", description: "공통 지인이나 게시물을 통해 당신에 대한 정보를 모으기 시작합니다.", emoji: "📋" },
    { title: "접근 시도", description: "자연스러운 만남이나 온라인 접점을 만들어 대화를 시도합니다.", emoji: "🎯" },
    { title: "감정 폭발", description: "한번 교감이 시작되면 빠르게 감정이 깊어지며 적극적으로 표현합니다.", emoji: "🔥" },
  ],
  [
    { title: "무의식적 관심", description: "의식하지 못하는 사이에 당신의 게시물을 자주 확인하게 됩니다.", emoji: "🌀" },
    { title: "내적 갈등", description: "끌림을 느끼면서도 다가가야 할지 고민하며 시간을 보냅니다.", emoji: "💫" },
    { title: "결심과 행동", description: "더 이상 참지 못하고 용기를 내어 첫 연락을 시도합니다.", emoji: "✨" },
    { title: "올인 모드", description: "관계가 시작되면 당신에게 완전히 집중하며 깊은 유대를 형성합니다.", emoji: "❤️‍🔥" },
  ],
];
